 ...
 *
 * Usage:
 *   node scripts/ops/smoke-vanguard.mjs
 *   node scripts/ops/smoke-vanguard.mjs --with-service-role
 *   node scripts/ops/smoke-vanguard.mjs --invoke-safe
 *   node scripts/ops/smoke-vanguard.mjs --invoke-crons   # side effects possible
 *
