-- Career module + legacy goals table: archived/dropped 2026-06-30.
-- RPC must switch to canonical projects/todo_items BEFORE dropping career_* tables.
...
-- Legacy goals table (0 rows in prod audit) — life_goals is the canonical BHAG store.
ALTER TABLE IF EXISTS public.projects DROP CONSTRAINT IF EXISTS projects_goal_id_fkey;
ALTER TABLE IF EXISTS public.goal_kpis DROP CONSTRAINT IF EXISTS goal_kpis_goal_id_fkey;
ALTER TABLE IF EXISTS public.projects DROP COLUMN IF EXISTS goal_id;
ALTER TABLE IF EXISTS public.goal_kpis DROP COLUMN IF EXISTS goal_id;
DROP TABLE IF EXISTS public.goals CASCADE;

-- Career module tables (archived to docs/archive/career_projects_export_2026-06-30.json).
DROP TABLE IF EXISTS public.career_decisions CASCADE;
DROP TABLE IF EXISTS public.career_evidence CASCADE;
DROP TABLE IF EXISTS public.career_moves CASCADE;
DROP TABLE IF EXISTS public.career_projects CASCADE;
