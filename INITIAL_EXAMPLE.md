...
- `src/components/DailyStrainCard.jsx` — wzorzec refresh z wieloma równoległymi callami i error propagation
- `src/components/OuraWidget.jsx` — jak czytać z `oura_daily_summary` z Warsaw date filterem
...
- Karta trafia do `src/components/SleepDebtCard.jsx` i jest montowana w `Dashboard.jsx` w sekcji Body obok `DailyStrainCard`
