          ...
          <p className="font-bold text-text-primary">
            ...
            {ctx.targetKcal != null ? (
              <span className="text-text-muted font-semibold">
                {' '}/ {ctx.targetKcal}
                {remainingKcal != null && (
                  <span className={remainingKcal < 0 ? ' text-warning' : ' text-success'}>
                    {' '}
            ...
            {ctx.targetProtein != null ? (
              <span className="text-text-muted font-semibold">
                ...
                {remainingProtein != null && remainingProtein > 0 ? (
                  <span className="text-warning"> · brakuje {remainingProtein} g</span>
      ...
      <div className="flex items-center justify-between gap-2 border-t border-border-custom/40 pt-2">
        <div className="min-w-0 space-y-1 text-2xs text-text-muted leading-snug">
          ...
          {trend != null ? (
            <p>
              Tempo ze wagi:{' '}
              <span className={stalling ? 'font-bold text-warning' : 'font-bold text-success'}>
                {trend >= 0 ? '+' : ''}
          ...
          {ctx.forecastWeight90d != null || ctx.forecastBf90d != null ? (
            <p>
              ...
              {stalling && goalBfLabel ? (
                <span className="text-warning"> — nie domyka {goalBfLabel}</span>
              ) : null}
            </p>
          ) : null}
        ...
        <Button
          ...
          className={logClosed ? 'border-success/40 bg-success/10 text-success hover:bg-success/15' : ''}
        >
