...
export default function CalendarView({
  ...
  const integrations = useCalendarIntegrations({
    ...
    focusTimeDefense: calData.focusTimeDefense,
    decompressionBuffer: calData.decompressionBuffer,
    inboxTodos: calTodos.inboxTodos,
    ...
    fetchAllTodos: calTodos.fetchAllTodos,
  ...
  const contextValue: CalendarContextType = {
    ...
    isSyncing,
    isAISchedulingRunning: integrations.isAISchedulingRunning,
    isSyncingOura: integrations.isSyncingOura,
    isSyncingActivities: integrations.isSyncingActivities,
    onSyncCalendar,
    runAIScheduling: integrations.runAIScheduling,
