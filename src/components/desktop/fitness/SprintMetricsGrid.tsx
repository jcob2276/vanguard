...
>) {
  ...
  return (
    <div className="grid grid-cols-3 gap-6 pt-5 border-t border-primary/10">
      <div>
        <p className="text-2xs font-black uppercase tracking-[var(--ds-arbitrary-0-25em)] text-success mb-3">Ciało · sprint</p>
      ...
      <div>
        <p className="text-2xs font-black uppercase tracking-[var(--ds-arbitrary-0-25em)] text-warning mb-3">Projekty · sprint</p>
        <div className="grid grid-cols-2 gap-x-5 gap-y-3">
      ...
      <div>
        <p className="text-2xs font-black uppercase tracking-[var(--ds-arbitrary-0-25em)] text-primary mb-3">Cele kierunkowe</p>
        <div className="space-y-2">
          {goals?.goal_konto && (
            <Card variant="outline" padding="0.625rem 0.75rem" className="!rounded-[var(--radius-sm)] !bg-warning/[0.06] !border-warning/15 hover:scale-[var(--ds-arbitrary-1-03)] hover:shadow-md hover:!border-warning/30 cursor-default">
          ...
          {goals?.goal_duch && (
            <Card variant="outline" padding="0.625rem 0.75rem" className="!rounded-[var(--radius-sm)] !bg-primary/[0.06] !border-primary/15 hover:scale-[var(--ds-arbitrary-1-03)] hover:shadow-md hover:!border-primary/30 cursor-default">
