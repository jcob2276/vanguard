    ...
    <Panel title="">
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-2xs font-black uppercase tracking-[0.25em] text-text-muted">Lista Marzeń</p>
        ...
        {isAddingDream && (
          <div className="rounded-xl border border-primary/15 bg-primary/[0.03] p-3.5 space-y-2.5">
            <div className="flex gap-2">
              ...
              <Button variant="primary" size="sm" onClick={addDream} className="rounded-xl px-4 py-2 text-xs font-black uppercase tracking-widest hover:bg-primary/90 transition-all cursor-pointer">
                Dodaj
              </Button>
        ...
        {top5Dreams.length > 0 && (
          <div className="space-y-2">
            <p className="text-2xs font-black uppercase tracking-[0.25em] text-warning flex items-center gap-1.5">
            ...
            <div className="space-y-1.5">
              {top5Dreams.map(dream => (
                <Card key={dream.id} variant="glass" padding="0.625rem 0.875rem" className="flex items-center gap-2.5" style={{ borderRadius: '14px', border: '1px solid rgba(245,158,11,0.2)', background: 'rgba(245,158,11,0.04)' }}>
                  ...
                  <Button variant="ghost" size="sm" onClick={() => openDreamModal(dream)} className="flex-1 text-left text-xs font-bold text-text-primary hover:text-primary truncate cursor-pointer">
                    {dream.title}
                  </Button>
