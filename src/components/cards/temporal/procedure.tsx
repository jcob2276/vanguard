      ...
      <ol className="space-y-2">
        {data.steps.map(s => (
          <li key={s.step} className="flex items-start gap-3">
            <span className="w-5 h-5 rounded-full flex-shrink-0 flex items-center justify-center text-[10px] font-bold" style={{ background: s.done ? 'rgba(16,185,129,0.15)' : 'rgba(91,108,255,0.1)', color: s.done ? '#10B981' : '#5B6CFF' }}>{s.step}</span>
