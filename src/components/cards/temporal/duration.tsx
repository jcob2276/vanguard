...
export function DurationCard({ data }: { data: DurationData }) {
  ...
  return (
    <div className="flex items-center gap-3">
      <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 bg-[color:var(--ds-bg-rgba-245-158-11-0-1)]">
      ...
      <div>
        ...
        <p className="text-lg font-[var(--ds-arbitrary-800)] leading-none" style={{ color: 'var(--text-primary)' }}>{h > 0 ? `${h}h ` : ''}{m > 0 ? `${m}min` : ''}</p>
