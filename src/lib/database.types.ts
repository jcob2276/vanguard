...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      life_goals: {
        Row: {
          ...
          anti_goal_cialo: string | null
          anti_goal_duch: string | null
          anti_goal_konto: string | null
    ...
    Functions: {
      ...
      oracle_readonly_query: { Args: { query_text: string }; Returns: Json }
      remove_food_entry: {
      ...
      resolve_entity_decision: {
        Args: {
          ...
          p_kind: string
          p_name: string
          p_threshold_diff?: number
          p_threshold_same?: number
          p_user_id: string
        }
        Returns: string
      }
      resolve_entity_fuzzy_candidates: {
        Args: { p_kind: string; p_name: string; p_user_id: string }
        Returns: {
          alias: string
          canonical_name: string
